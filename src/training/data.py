...
class DeGLA_dataset(Dataset):
    ...
    def __getitem__(self,index):
        ...
        neg_text1 = self.samples[index]['enhanced'][0]
        neg_text1 = self.tokenize([str(neg_text1)])[0]
        neg_text2 = self.samples[index]['enhanced'][1]
        neg_text2 = self.tokenize([str(neg_text2)])[0]
        neg_text3 = self.samples[index]['enhanced'][2]
