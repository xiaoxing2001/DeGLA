...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help="text local contrast",        
        )
    parser.add_argument(
        "--text_local_weight",
        type=float,
        default=0.1,
        help="text local weight",
    )
    parser.add_argument(
        "--image_local_contrast",
        default=False,
        action='store_true',
        help="image local contrast",
    )
    parser.add_argument(
        "--image_local_weight",
        type=float,
    ...
    parser.add_argument(
        ...
        type=int,
        nargs='+',
        help='List of transformer layers to freeze',
        default=None)
    parser.add_argument(
        "--text_layers_to_freeze",
        type=int,
        nargs='+',
        help='List of transformer layers to freeze',
        default=None)    
    ...
    parser.add_argument("--frozen_text",
        default = False,
        action = 'store_true')   
    ...
    parser.add_argument(
        "--warmup", type=int, default=50, help="Number of steps to warmup for."
    )
    parser.add_argument(
        "--use-bn-sync",
        default=False,
    ...
    parser.add_argument(
        '--force-image-size', type=int, nargs='+',
